...
const ArticleItem = ({ article, auth: { isAuthenticated, user } }) => {
  const editbtn = (
        ...
        <div className="container">
          <UserHeader>
            <div className="left">
              ...
              <Avatar className="imgholder" avatar={article.user && article.user.avatar} />
            </div>
            ...
            <div className="right">
              ...
              <div className="articleedit">{isAuthenticated && user.id === article.user._id ? editbtn : ""}</div>
            </div>
          </UserHeader>
          ...
          <div className="articledetails contentbody">
            ...
            <div id="theText" className="articleText" dangerouslySetInnerHTML={{ __html: article.text }}></div>
...
export const View = connect(mapStateToProps)(ArticleItem);
